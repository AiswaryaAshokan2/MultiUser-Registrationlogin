...
namespace MultiUser_Registrationlogin
{
    public partial class AdminReg : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "insert into dbo.Admin_Reg_tab values(" + reg_id + ",'" + TextBox1.Text + "','" + TextBox2.Text + "')";
            int i = objcls.Fun_Non_Query(ins);
            if (i == 1)
            {
                string inslog = "insert into dbo.Login_tab values(" + reg_id + ",'" + TextBox3.Text + "','" + TextBox4.Text + "','admin','active')";
